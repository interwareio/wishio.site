...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-slate-900 py-12">
      {/* Top Border Gradient */}
        ...
        >
          ...
          <div className="flex justify-center mb-8">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-slate-800/50 rounded-full text-slate-400 hover:text-rose-400 transition-colors"
            >
          ...
          {/* Social Links */}
          {(siteConfig.socialLinks.twitter || siteConfig.socialLinks.instagram || siteConfig.socialLinks.facebook) && (
